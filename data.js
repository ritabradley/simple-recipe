export const recipeData = {
  ...
  mainImage: '../src/assets/cheesecake.jpg',
  cookingDetails: {
    yield: '12 servings',
    prepTime: '45 minutes',
    cookTime: '1 hour',
    totalTime: '7 hours 45 minutes',
  },
  ingredientList: [
    {
    ...
    },
    {
      ...
      ingredients: [
        ...
        {
          name: 'fresh lemon juice (optional, but recommended)',
          amount: '2 teaspoons',
        },
        {
        ...
        {
          name: 'topping suggestions: salted caramel, lemon curd, strawberry topping, chocolate ganache, red wine chocolate ganache, fresh fruit, whipped cream, or raspberry sauce',
        },
      ],
    },
  ],
